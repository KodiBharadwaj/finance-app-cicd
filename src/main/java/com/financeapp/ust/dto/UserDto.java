...
public record UserDto(int id, String email, String phoneNo, String password, List<Income> incomes, List<Expense> expenses, List<Budget> budgets, List<Goals> goals) {
}
